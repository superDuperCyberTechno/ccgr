...
This game is based on the proprietary game *Sea Salt & Paper* with changes to accommodate a standard deck of cards, mostly picked from the rummy family.
...
There is no limit to how many cards a player can play during their turn. Players must discard down to 7 cards before the next player's turn, if applicable.
